...
class UnitsController extends Controller
{
        ...
        if($request->isAjax){
            ...
            if($request->isGet){
                ...
                return [
                    ...
                    'footer'=> Html::button('Amalni tugatish',['class'=>'btn btn-secondary float-left','data-dismiss'=>"modal"]).
    ...
    /**
     * Delete an existing Units model.
     * For ajax request will return json object
    ...
    public function actionDelete($id)
    {
     ...
     /**
     * Delete multiple existing Units model.
     * For ajax request will return json object
     * and for non-ajax request if deletion is successful, the browser will be redirected to the 'index' page.
     * @param integer $id
     * @return mixed
