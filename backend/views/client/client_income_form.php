        ...
        <div class="row">
            <div class="col-md-3">
                ...
                <input type="text" class="form-control" disabled
                       value="<?= $model->unity_type_id ? $model->unityType->name : '' ?>" id="income-unity_type_id">

            </div>
            <div class="col-md-3">
                <label id="price-label">1 tonna uchun narx</label>
                <?= $form->field($model, 'cost')->textInput()->label(false) ?>
                ...
                ?>">
                    ...
                    <?= $form->field($model, 'length')->textInput()->label(false) ?>
                </div>
            ...
            <div class="col-md-3">
                ...
                ?>; margin-top: 16px">
                    <?= $form->field($model, 'price_per_meter')->textInput() ?>
                </div>
            </div>
            <div class="col-md-3">
                ...
                <input
                        ...
                        disabled
                        value="<?= $model->total ? number_format($model->total, 0, ' ', ' ') : 0 ?>">
            </div>
        </div>
