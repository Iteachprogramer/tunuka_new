...
$this->title = Yii::t('app', 'Dollar Courses');
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Create new Dollar Courses','class'=>'btn btn-secondary']).
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="fas fa-list-alt"></i> Dollar Courses listing',
