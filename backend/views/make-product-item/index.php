...
$this->title = Yii::t('app', 'Make Product Items');
        ...
        <?=GridView::widget([
            ...
            'toolbar'=> [
                ['content'=>
                    ...
                    ['role'=>'modal-remote','title'=> 'Create new Make Product Items','class'=>'btn btn-secondary']).
            ...
            'panel' => [
                'type' => 'primary',
                'heading' => '<i class="fas fa-list-alt"></i> Make Product Items listing',
