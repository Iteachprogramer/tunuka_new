...
namespace sale\modules\profilemanager\controllers;

use sale\modules\profilemanager\models\ChangePasswordForm;
use sale\modules\profilemanager\models\ProfileUser;
use Yii;
